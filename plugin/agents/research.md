...
1. **Map the relevant code.** Grep/Glob to find the files, modules, and patterns this request touches. Read them. Note existing conventions, the data model, the test setup, and anything that constrains the solution.
